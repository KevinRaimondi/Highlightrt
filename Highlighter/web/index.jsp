...
<div id="page">
	<div id="page-bgtop">
		<div id="content">
            <h2 class="title"><a href="#">Base para adicionar o banco de dados/2ºpart</a></h2>
		<iframe src="conteudo_iframe.htm" style="width:620px;height:520px;" frameborder="200" scrolling="no" name="meio"></iframe>
	</div>
		<!-- fim do iframe-->
        <!-- Lista de categorias-->
		<div id="sidebar">
